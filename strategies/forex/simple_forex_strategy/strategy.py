"""
Simple Forex Strategy - SMA Crossover
==============================================================================
A simple moving average crossover strategy for forex trading.

This strategy:
- Uses fast/slow SMA crossover for entry/exit signals
- Operates on 24/5 FOREX calendar
- Uses Yahoo Finance EUR/USD data
==============================================================================
"""
...
def compute_signals(context, data):
    ...
    fast_period = context.params['strategy'].get('short_period', 10)
    slow_period = context.params['strategy'].get('long_period', 30)
