...
def plot_rolling_metrics(
    ...
    # Rolling Sharpe
    axes[0].plot(
        rolling.index, rolling["rolling_sharpe"], linewidth=1.5, color="#2E86AB", label="Sharpe"
    )
    ...
    # Rolling Sortino
    axes[1].plot(
        rolling.index, rolling["rolling_sortino"], linewidth=1.5, color="#E63946", label="Sortino"
    )
