...
def _build_report_content(
    ...
    # Add Zipline native metrics section (complements lib/metrics)
    zipline_section = build_zipline_metrics_section(results_dir)
    if zipline_section:
        content += zipline_section

    # Add time-series summary from Zipline
    time_series_section = build_time_series_summary(results_dir)
    if time_series_section:
        content += time_series_section
