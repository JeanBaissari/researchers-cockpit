...
class BaseValidator(ABC):
    ...
    def _create_result(self) -> ValidationResult:
        ...
        result.add_metadata(
            "config", {"strict_mode": self.config.strict_mode, "timeframe": self.config.timeframe}
        )
    ...
    def _run_check(
        self, result: ValidationResult, check_func: Callable[..., ValidationResult], *args, **kwargs
    ) -> ValidationResult:
        """
