...
Provides high-level API functions for validation tasks:
- validate_before_ingest(): Pre-ingestion OHLCV validation
- validate_bundle(): Bundle integrity validation
- validate_backtest_results(): Backtest results validation
- validate_csv_files_pre_ingestion(): Batch CSV validation
- verify_*(): Verification utilities for metrics, returns, positions
"""
