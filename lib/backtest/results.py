...
def save_results(
    ...
    # Save full performance DataFrame as pickle (preserves Zipline native metrics)
    save_performance_dataframe(perf_normalized, result_dir)
