...
class TestFixedPositionSizing:
    ...
    def test_fixed_method_returns_max_position(self):
        ...
        context = Mock()
        context.params = {"position_sizing": {"method": "fixed", "max_position_pct": 0.95}}
        data = Mock()
    ...
    def test_fixed_method_with_defaults(self):
        ...
        context = Mock()
        context.params = {"position_sizing": {"method": "fixed"}}
        data = Mock()
...
class TestVolatilityScaledPositionSizing:
    ...
    def test_volatility_scaled_cannot_trade_fallback(self):
        ...
        context.asset = Mock()
        context.params = {
            "position_sizing": {"method": "volatility_scaled", "max_position_pct": 0.95}
        }
    ...
    def test_volatility_scaled_different_asset_classes(self):
        ...
        for asset_class, expected_trading_days in [
            ("equities", 252),
            ("forex", 260),
            ("crypto", 365),
        ]:
...
class TestPositionSizingEdgeCases:
    ...
    def test_unknown_method_fallback(self):
        ...
        context = Mock()
        context.params = {"position_sizing": {"method": "unknown_method", "max_position_pct": 0.90}}
        data = Mock()
    ...
    def test_uses_context_params_if_params_none(self):
        ...
        context = Mock()
        context.params = {"position_sizing": {"method": "fixed", "max_position_pct": 0.80}}
        data = Mock()
