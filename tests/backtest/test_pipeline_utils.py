...
from lib.pipeline_utils import setup_pipeline, is_pipeline_available, validate_pipeline_config
...
class TestSetupPipeline:
    ...
    def test_pipeline_disabled_in_params(self):
        ...
        context = Mock()
        params = {"strategy": {"use_pipeline": False}}
    ...
    def test_pipeline_not_available_warning(self):
        ...
        context = Mock()
        params = {"strategy": {"use_pipeline": True}}
    ...
    def test_pipeline_warning_for_non_equities(self):
        ...
        context = Mock()
        params = {"strategy": {"use_pipeline": True, "asset_class": "crypto"}}
        ...
        with patch("lib.pipeline_utils._PIPELINE_AVAILABLE", True):
            with patch("lib.pipeline_utils.attach_pipeline"):
                with warnings.catch_warnings(record=True) as w:
                    ...
                    assert any(
                        "primarily designed for US equities" in str(warning.message)
                        for warning in w
                    )
    ...
    def test_pipeline_setup_success(self):
        ...
        context = Mock()
        params = {"strategy": {"use_pipeline": True, "asset_class": "equities"}}
