...
class TestTakeProfit:
    ...
    def test_take_profit_triggered(self):
        ...
        current_price = 110.0
        entry_price = 100.0
        risk_params = {"use_take_profit": True, "take_profit_pct": 0.10}
...
class TestTrailingStop:
    ...
    def test_trailing_stop_with_zero_highest_price(self):
        ...
        current_price = 90.0
        highest_price = 0.0
        risk_params = {"use_trailing_stop": True, "trailing_stop_pct": 0.08}
...
class TestFixedStop:
    ...
    def test_fixed_stop_with_zero_entry_price(self):
        ...
        current_price = 90.0
        entry_price = 0.0
        risk_params = {"use_stop_loss": True, "stop_loss_pct": 0.05}
...
class TestConfigureZiplineControls:
    """Test Zipline controls configuration."""

    @pytest.mark.unit
    def test_empty_controls(self):
        """Test that empty controls dict does nothing."""
        context = Mock()
        configure_zipline_controls(context, {})
        # Should not raise any errors

    @pytest.mark.unit
    def test_none_controls(self):
        """Test that None controls does nothing."""
        context = Mock()
        configure_zipline_controls(context, None)
        # Should not raise any errors

    @pytest.mark.unit
    @pytest.mark.skip(reason="Requires Zipline API to be available in test environment")
    def test_configure_leverage(self):
        """Test leverage configuration."""
        # This test would require actual Zipline API
        # Skipped since it needs full Zipline environment
        pass

    @pytest.mark.unit
    @pytest.mark.skip(reason="Requires Zipline API to be available in test environment")
    def test_configure_long_only(self):
